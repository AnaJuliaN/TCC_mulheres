    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <div class="row">
              ...
              $result_com = "SELECT usuario.nome, comentários.descricao, comentários.cod_relato FROM usuario INNER JOIN comentários ON usuario.cod_usuario = comentários.cod_usuario WHERE comentários.cod_relato = '$cod_r'";
              ...
              <a href='relatos.php' class='dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30'><img src='img/flecha.png' width=10 height=10>
							Voltar
