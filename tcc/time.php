  ...
  <main>
    <div class="container-fluid">
      ...
      <div id="team-area">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card">
                <img src="img/profile1.jpg"  class="img-thumbnail" alt="Imagem de Perfil 1">
                <div class="card-body">
                  <h5 class="card-title">Amanda Guidi</h5>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card">
                <img src="img/profile2.jpg"  class="img-thumbnail" alt="Imagem de Perfil 2">
                <div class="card-body">
                  <h5 class="card-title">Ana Julia Simão Nunes</h5>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card">
                <img src="img/profile3.jpg" class="img-thumbnail" alt="Imagem de Perfil 3">
                <div class="card-body">
                  <h5 class="card-title">Isadora Almeida</h5>
                </div> 
              </div>
            </div>
          </div>
      ...
      <div style='text-align:center;'>
          <p class="cor"> 
            <p style="font-size: 20px;"> <b> Olá! Somos alunas do Técnico em Informática do Instituto Federal de Araraquara. </b>
            <br />
            O site no qual está navegando é um trabalho de conclusão de curso. O intuito do nosso site 
            é ajudar mulheres 
            <br /> por meio de informações sobre a violência que pode ser cometida contra elas.
            <br/>
            <br/>
            </p>
          </p>
